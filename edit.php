...
$mhs = query("SELECT * FROM data_pegawai WHERE id = $id") [0];
...
<form action="" method="post" enctype="multipart/form-data">
  ...
  <div class="col-md-6">
    ...
    <select id="posisi" name="posisi" class="form-select" required autocomplete="off" value="<?= $mhs["posisi"] ?>">
      <option>---</option>
      <option>Sekretaris</option>
      <option>Kepala dusun</option>
      <option>Ketua RT</option>
    </select>
  </div>
  <div class="col-md-6">
    <label for="gaji" class="form-label">gaji</label>
    <input type="text" name="gaji" class="form-control" id="gaji" placeholder="contoh : 2015" required autocomplete="off" value="<?= $mhs["gaji"] ?>">
  </div>
  <div class="col-12">
