  ...
  <body>
    ...
    <nav class="navbar navbar-light bg-success object-fit-cover border rounded mt-3">
        <div class="container-fluid">
          <a class="navbar-brand"><img src="image/desa.jpg " width="50" class="rounded float-start" alt=""></a>
    ...
    <div class="container">
        ...
        <figure class="text-center mt-4">
          ...
          <p>Kepegawaian kantor</p>
        </blockquote>
        <figcaption class="blockquote-footer">
          <cite title="Source Title">Desa sungai rambut</cite>
        </figcaption>
      </figure>
      <h1>Selamat Datang</h1>
      <h6>Desa sungai rambut</h6>
      <p>
